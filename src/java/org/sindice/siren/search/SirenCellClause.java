...
implements java.io.Serializable {
   ...
   */
  public SirenCellClause(final SirenPrimitiveQuery query, final Occur occur) {
    this.query = query;
    this.occur = occur;
  }
  ...
  public boolean equals(final Object o) {
    if (o == null || !(o instanceof SirenCellClause)) return false;
    final SirenCellClause other = (SirenCellClause) o;
