...
extends SirenScorer {
  ...
  private final List<SirenBooleanScorer> requiredScorers   = new ArrayList<SirenBooleanScorer>();

  private final List<SirenBooleanScorer> optionalScorers   = new ArrayList<SirenBooleanScorer>();

  private final List<SirenBooleanScorer> prohibitedScorers = new ArrayList<SirenBooleanScorer>();
  ...
  public void add(final SirenBooleanScorer scorer, final boolean required,
  ...
  private SirenScorer countingDisjunctionSumScorer(final List<SirenBooleanScorer> scorers)
  ...
  private SirenScorer countingConjunctionSumScorer(final List<SirenBooleanScorer> requiredScorers)
  throws IOException {
    // each scorer from the list counted as a single matcher
  ...
  private class SingleMatchScorer extends SirenScorer {
    ...
    private final SirenBooleanScorer scorer;

    private int          lastScoredEntity = -1;

    SingleMatchScorer(final SirenBooleanScorer scorer) {
